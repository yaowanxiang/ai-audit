...
# 设置环境变量
$repoName = "ai-audit"
$repoDesc = "AI code security certification framework: hallucination audit, data provenance, standard mapping (GB/T, SLSA, EU AI Act), 7-language support"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "🔗 仓库地址: https://github.com/yaowanxiang/$repoName" -ForegroundColor Cyan
} else {
...
Write-Host "1. 访问仓库: https://github.com/yaowanxiang/$repoName" -ForegroundColor Gray
